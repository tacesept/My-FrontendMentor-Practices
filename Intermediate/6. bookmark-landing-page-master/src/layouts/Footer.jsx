...
export default function Footer() {
  return (
    <footer className="bg-black flex flex-col gap-4 md:flex-row justify-between items-center
                      py-10 px-4 md:px-6 lg:px-8">
      <div
      ...
      >
        ...
        <Navbar variant="text-white" layout="flex-col md:flex-row gap-4" />
      </div>
